...
const HomeComponent = () => {
    ...
    return (
        <>
            ...
            <Container componentToPassDown={<Carousel />}  className="componentContainer" />
            <Container componentToPassDown={<Collections  className="componentContainer" />} />
            <Container componentToPassDown={<Artists />}  className="componentContainer" />
        </>
    );
}
